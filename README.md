...
| <th align="left">NumPy<=1.26.4: `pip install classixclustering` </th> <br/> NumPy>2: `pip install classixclustering --no-cache-dir `| `conda install -c conda-forge classixclustering` |
